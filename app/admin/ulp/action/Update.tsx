...
import { UlpTb } from "@prisma/client"
...
function Update({ ulp, reload }: { ulp: UlpTb, reload: Function }) {
    const session = useSession()
    const [nama, setNama] = useState(ulp.nama)
    const [alamat, setAlamat] = useState(ulp.alamat)
    ...
    const handleUpdate = async (e: SyntheticEvent) => {
        ...
        try {
            ...
            const xxx = await axios.patch(`/admin/api/ulp/${ulp.id}`, formData, {
                headers: {
            ...
            <Modal
                ...
                <form onSubmit={handleUpdate}>
                    <Modal.Header closeButton>
                        <Modal.Title style={{ color: "black" }}>Edit Data ULP</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div className="row">
