...
const Penyulang = () => {
  ...
  const filteredItems = datapenyulang.filter(
  ...
  const columns = [
    ...
    {
      name: 'ULP',
      selector: (row: any) => row.UlpTb?.nama,
      width: '150px'
    },
    {
      name: 'Jenis Layanan',
    ...
    },
    {
      ...
      cell: (row: any) => (
        <div className="d-flex">
          <Update reload={reload} penyulang={row} daftarulp={dataulp}/>
          <Delete reload={reload} penyulangId={row.id} />
        </div>
      ),
    },
        ...
        <div className="col-md-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-header">
              <h1 className="card-title" >Data Penyulang</h1>
            </div>
